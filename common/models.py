...
# 商人价格表
MERCHANT_PRICES = {
    # 商人出售的价格（村民购买）- 故意定价较高，鼓励村民间交易
    "buy": {
        # 原材料 - 定价较高，鼓励村民间交易
        "wood": 8,        # 木材 (成本较高，鼓励木工间交易)
        "seed": 3,         # 种子 (成本较高，鼓励农夫间交易)
        "wheat": 4,        # 小麦 (成本较高，鼓励农夫-厨师交易)
        
        # 产物 - 定价很高，鼓励村民间交易
        "bread": 25,       # 面包 (成本很高，鼓励厨师间交易)
        "house": 200,      # 住房 (成本很高，鼓励木工间交易)
        
        # 特殊物品
        "temp_room": 15,  # 临时房间券 (合理定价)
    },
    # 商人收购的价格（村民出售）- 故意定价较低，鼓励村民间交易
    "sell": {
        # 原材料 - 收购价很低，鼓励村民间交易
        "wood": 2,        # 木材 (收购价很低)
        "seed": 1,        # 种子 (收购价很低)
